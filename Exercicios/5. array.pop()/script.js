const listagemDeFrutas = [ "Uva", "Banana", "Manga", "Cajá", "Pinha", "Maçã", "Melão"];
 ...
 // const ultimoElementoLista = listagemDeFrutas.pop();
// console.log(listagemDeFrutas);
// console.log(ultimoElementoLista);
...
//conlose.log (usuarios.pop());

const removeUsuarios = usuarios.pop();

// const listagemDeFrutas = listagemDeFrutas.pop();

// console.log(listagemDeFrutas);

// console.log(listagemDeFrutasPop);
